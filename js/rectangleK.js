...
var rect = (function () {
        ...
        handler.setInputAction(
            function (movement) {
                ...
                if (mouseOutObject && (!pickedObject || mouseOutObject !== pickedObject.primitive)) {
                    !(mouseOutObject.isDestroyed1 && mouseOutObject.isDestroyed1()) && mouseOutObject.mouseOut(movement.endPosition);
                    mouseOutObject = null;
                }
    ...
    _.prototype.registerEditableShape = function (surface) {
        ...
        setListener(surface, 'mouseMove', function (position) {
            ...
            if (!surface._editMode) {
                _self._tooltip.showAt(position, "左击编辑形状<br>右击取消选区");
            }
        });
      ...
      $('#fangqixuanqu,#selallBtn,#polygonBox,#rectBox').click(function () {
        surface.setEditMode(false);
        this._markers=null;
        this._editMarkers=null;
        scene.primitives.remove(surface);
    ...
    _.prototype.setHighlighted = function (surface) {
        if (this._highlightedSurface && !this._highlightedSurface.isDestroyed1() && this._highlightedSurface !== surface) {
    ...
    _.prototype.setEdited = function (surface) {
        if (this._editedSurface && !this._editedSurface.isDestroyed1()) {
    ...
    material.uniforms.color = new Cesium.Color(1.0, 1.0, 0.0, 0.3);
    ...
    var ChangeablePrimitive = (function () {
        ...
        _.prototype.isDestroyed1 = function () {
            return false;
        };
    ...
    _.prototype.startDrawingExtent = function (options) {
        ...
        mouseHandler.setInputAction(function (movement) {
            ...
            if (position !== null) {
                if (extent === null) {
                    tooltip.showAt(position, "<p>左击鼠标开始</p>");
                } else {
                    ...
                    if (cartesian) {
                        ...
                        tooltip.showAt(position, "移动鼠标改变形状<br>左击确定");
                    }
                }
            }
        }, Cesium.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.prototype.enhancePrimitives = function () {
        ...
        rect.ExtentPrimitive.prototype.setEditable = function () {
                    ...
                    if (this._markers == null) {
                        ...
                        this._globeClickhandler.setInputAction(
                            function (movement) {
                                ...
                                if (!(pickedObject && !pickedObject.isDestroyed1() && pickedObject.primitive)) {
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            addIcon('extent', options.extentIcon, '选择框选范围', function () {
