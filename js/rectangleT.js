...
var Rectangle = (function () {
    ...
    _.prototype.registerEditableShape = function (surface) {
        ...
        setListener(surface, 'mouseMove', function (position) {
            ...
            if (!surface._editMode) {
                _self._tooltip.showAt(position, "左击编辑形状<br>右击取消选区<br>双击进入选区<br>");
            }
        });
    ...
    material.uniforms.color = new Cesium.Color(0.0, 1.0, 1.0, 0.3);
            ...
            if (position != null) {
                if (extent == null) {
                    ...
                    if (cartesian) {
                        ...
                        tooltip.showAt(position, "移动鼠标改变形状<br>左击确定，双击查看");
                    }
                }
            }
        }, Cesium.ScreenSpaceEventType.MOUSE_MOVE);
    ...
    _.prototype.enhancePrimitives = function () {
        ...
        Rectangle.ExtentPrimitive.prototype.setEditable = function () {
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            addIcon('extent', options.extentIcon, '选择显示/搜索范围', function () {
